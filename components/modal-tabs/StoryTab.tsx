...
export default function StoryTab({ miracle }: StoryTabProps) {
  return (
    <div className="space-y-4 sm:space-y-6">
      <h3 className="text-xl sm:text-2xl font-semibold text-holy-gold">The Miracle Story</h3>
      ...
      {miracle.historicalContext && (
        <div className="p-4 sm:p-6 bg-holy-gold/10 rounded-lg border border-holy-gold/30">
          <h4 className="text-base sm:text-lg font-semibold mb-3 text-holy-gold">Historical Context</h4>
      ...
      {miracle.timeline && miracle.timeline.length > 0 && (
        <div>
          <h4 className="text-base sm:text-lg font-semibold mb-4 text-holy-gold flex items-center gap-2">
